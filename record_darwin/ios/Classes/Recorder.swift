...
public class Recorder {
  ...
  func start(config: RecordConfig, path: String) throws {
    ...
    try delegate.start(config: config, path: path, parentRecorder:self)
  ...
  func startStream(config: RecordConfig) throws {
    ...
    try delegate.start(config: config, recordEventHandler: m_recordEventHandler, parentRecorder: self)
